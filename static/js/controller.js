...
$(document).ready(function () {
    ...
    $('select[name="exposure-mode"]').change(function () {
        sendCameraSetting({
            message_type: AUTOEXP_SET,
            auto_exp: this.value === 'exposure-auto',
            app_run: true
        });
    });
    ...
    var exposureTime = document.getElementById("exposure-time");
    var exposureOutput = document.getElementById("exposure-seconds");
    exposureOutput.innerHTML = exposureTime.value;

    exposureTime.oninput = function () {
        exposureOutput.innerHTML = this.value;
    }
    exposureTime.onmouseup = function () {
        sendCameraSetting({
            message_type: EXP_SET,
            exp_time: parseInt(this.value),
            app_run: true
        });
    }
    ...
    var analogGain = document.getElementById("analog-gain");
    var analogGainOutput = document.getElementById("analog-gain-output");
    analogGainOutput.innerHTML = analogGain.value;

    analogGain.oninput = function () {
        analogGainOutput.innerHTML = this.value;
    }
    analogGain.onmouseup = function () {
        sendCameraSetting({
            message_type: AGAIN_SET,
            analog_gain: parseInt(this.value),
            app_run: true
        });
    }
    ...
    var digitalGain = document.getElementById("digital-gain");
    var digitalGainOutput = document.getElementById("digital-gain-output");
    digitalGainOutput.innerHTML = digitalGain.value;

    digitalGain.oninput = function () {
        digitalGainOutput.innerHTML = this.value;
    }
    digitalGain.onmouseup = function () {
        sendCameraSetting({
            message_type: DGAIN_SET,
            digital_gain: parseInt(this.value),
            app_run: true
        });
    }
    ...
    var whiteBalanceRed = document.getElementById("white-balance-r");
    var whiteBalanceRedOutput = document.getElementById("white-balance-value-r");
    whiteBalanceRedOutput.innerHTML = whiteBalanceRed.value;

    whiteBalanceRed.oninput = function () {
        whiteBalanceRedOutput.innerHTML = this.value;
    }
    whiteBalanceRed.onmouseup = function () {
        sendCameraSetting({
            message_type: WB_KR_SET,
            wb_kr: parseFloat(this.value),
            app_run: true
        });
    }
    ...
    var whiteBalanceGreen = document.getElementById("white-balance-g");
    var whiteBalanceGreenOutput = document.getElementById("white-balance-value-g");
    whiteBalanceGreenOutput.innerHTML = whiteBalanceGreen.value;

    whiteBalanceGreen.oninput = function () {
        whiteBalanceGreenOutput.innerHTML = this.value;
    }
    whiteBalanceGreen.onmouseup = function () {
        sendCameraSetting({
            message_type: WB_KG_SET,
            wb_kg: parseFloat(this.value),
            app_run: true
        });
    }
    ...
    var whiteBalanceBlue = document.getElementById("white-balance-b");
    var whiteBalanceBlueOutput = document.getElementById("white-balance-value-b");
    whiteBalanceBlueOutput.innerHTML = whiteBalanceBlue.value;

    whiteBalanceBlue.oninput = function () {
        whiteBalanceBlueOutput.innerHTML = this.value;
    }
    whiteBalanceBlue.onmouseup = function () {
        sendCameraSetting({
            message_type: WB_KB_SET,
            wb_kb: parseFloat(this.value),
            app_run: true
        });
    }
});

// // Color Thumbnail Dialog
// $(function () {
//     $("#dialog").dialog({
//         modal: true,
//         autoOpen: false,
...
//             $(".ui-dialog").css('width', 'fit-content');
//             $(".ui-dialog").css('height', 'fit-content');
//         }
//     });
// });
